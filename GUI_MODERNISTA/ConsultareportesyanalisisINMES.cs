...
{
    public partial class ConsultareportesyanalisisINMES : UserControl
    {
        ...
        public ConsultareportesyanalisisINMES()
        {
            InitializeComponent();
        }
        ...
        private void UserControl1_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = Registroo.analisisyreportesMES(datos);
