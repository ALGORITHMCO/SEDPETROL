...
{
    public partial class ConsultareportesyanalisisINzonasmes : UserControl
    {
        ...
        public ConsultareportesyanalisisINzonasmes()
        {
            InitializeComponent();
        }
        ...
        private void UserControl1_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = Registroo.analisisyreporteszonasmes(datos);
