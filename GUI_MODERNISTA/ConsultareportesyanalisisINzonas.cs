...
{
    public partial class ConsultareportesyanalisisINzonas : UserControl
    {
        ...
        Panel panel;
        public ConsultareportesyanalisisINzonas(Panel p)
        {
            InitializeComponent();
            panel = p; 
        }
        ...
        private void UserControl1_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = Registroo.analisisyreporteszonas(datos);
        }
